<?php
/*
Plugin Name: Shortcode Tutorial by Lộc
Plugin Author: Loc
*/

//------- tỷ giá thế giới -------//
include plugin_dir_path(__FILE__) . 'shortcodes/ty-gia-the-gioi.php';


//------- tỷ giá AABank2 -------//
include plugin_dir_path(__FILE__) . 'shortcodes/ty-gia-AABank2.php';
