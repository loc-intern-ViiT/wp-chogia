<?php
add_shortcode('shortcode_lai_suat_vay_mua_nha_dat', 'create_shortcode_lai_suat_vay_mua_nha_dat');

function create_shortcode_lai_suat_vay_mua_nha_dat(){
    $response = wp_remote_get('https://apichogia.viit.com.vn/api/json/lai-suat?slug=vay-mua-nha-dat');
